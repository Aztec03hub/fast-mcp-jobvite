#!/usr/bin/env python3
"""Advisory-expiry owner. DESIGN.md:1566-1585, step 3 and step 4 only.
...
that must agree is the defect DESIGN.md:1581-1583 names, and it fails by
...
(DESIGN.md:1568-1571). This script cannot tell whether our code reaches
...
THE FOUR FIELDS a legal entry must carry (DESIGN.md:1574-1579):
...
MAX_IGNORE_DAYS = 30
"""DESIGN.md:1576-1577 - `an expiry date no more than 30 days out`."""
    ...
    for index, entry in enumerate(entries):
        ...
        if budget > MAX_IGNORE_DAYS:
            refusals.append(
                ...
                f"more than the {MAX_IGNORE_DAYS} DESIGN.md:1576-1577 allows"
            )
            continue
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Advisory-expiry gate. DESIGN.md:1566-1585."
    )
    parser.add_argument(
        "--pyproject",
        type=Path,
