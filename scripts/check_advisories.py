#!/usr/bin/env python3
"""Advisory-expiry owner. DESIGN.md:1504-1523, step 3 and step 4 only.
...
is the defect DESIGN.md:1519-1521 names, and it fails by going silently stale.
...
judgement written down, and it is NOT here** (DESIGN.md:1506-1509). This
...
THE FOUR FIELDS a legal entry must carry (DESIGN.md:1512-1517):
...
MAX_IGNORE_DAYS = 30
"""DESIGN.md:1516 - `an expiry date no more than 30 days out`."""
    ...
    for index, entry in enumerate(entries):
        ...
        if budget > MAX_IGNORE_DAYS:
            refusals.append(
                ...
                f"more than the {MAX_IGNORE_DAYS} DESIGN.md:1516 allows"
            )
            continue
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Advisory-expiry gate. DESIGN.md:1504-1523."
    )
    parser.add_argument(
        "--pyproject",
        type=Path,
