...
# DESIGN.md:1075-1078 requires `action == "accept" AND approve is True`,
...
# ===========================================================================
# THE ERA DISCRIMINATOR (DESIGN.md:1122-1125, FASTMCP-SPIKE-4.md:2063-2074)
# ===========================================================================

# The sessionless tuple swallows the handshake era, so a handshake call
# takes the MRTR path - which DESIGN.md:1086 measured as raising on
...
# The third case APPROVES instead of refusing. DESIGN.md:1126-1130 says
...
# DESIGN.md:1075-1078: `action == "accept" AND approve is True`.
# ===========================================================================
...
# The approval request stops naming the email. DESIGN.md:1061-1071: an
...
# DESIGN.md:721-727: a post-write audit failure must be SUCCESS WITH A
