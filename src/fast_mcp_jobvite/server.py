...
(DESIGN.md:1039-1046): even when teardown runs, it runs *after*
...
DESIGN.md:1338-1344 requires the shutdown case to assert the **teardown
...
def make_base_lifespan(settings: Settings) -> Lifespan:
    ...
    than an omission: DESIGN.md:1039-1046 records that the only
