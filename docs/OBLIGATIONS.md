...
| B77 | SUPERSEDED | `docs/DESIGN.md:1534` | `not written yet, deliberately` | `documentation/readme-standard.md:43` | Deferred with a recorded reason; scheduled as U13 |
...
| B103 | SUPERSEDED | `docs/DESIGN.md:1534` | `not written yet, deliberately` | `documentation/readme-standard.md:32-35` | Same disposition as B77 |
