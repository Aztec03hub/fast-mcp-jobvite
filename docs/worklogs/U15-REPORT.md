...
`DESIGN.md:1627-1629`'s claim - *"a CONFIDENTIAL PDF ... passes every secret scanner cleanly"* -
...
```
COMMIT REFUSED by the committed-file-type gate (DESIGN.md:1627-1634).
...
`DESIGN.md:1630-1631` requires that an override be reviewable in the diff. That is not a property of
...
the same reviewable shape `DESIGN.md:1630-1631` demands of the file-type gate's override. Both
...
`DESIGN.md:1632-1634` says this gate stops a **file** of the wrong type and does nothing about
