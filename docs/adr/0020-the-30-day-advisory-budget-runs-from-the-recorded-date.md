...
`DESIGN.md:1462-1467` requires that a time-boxed advisory ignore carry *"the advisory id, the date,
...
That is precisely the drift the expiry exists to stop. `DESIGN.md:1467` says so in the same sentence:
