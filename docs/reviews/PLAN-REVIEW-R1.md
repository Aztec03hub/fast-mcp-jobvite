...
units also cite `DESIGN.md:415` territory for the same mechanism. §4's collision list does not
...
- **Spike and standards cites, spot-checked at source:** `FASTMCP-SPIKE-4.md:898` (the literal
  ...
  design's seven-row subset at `DESIGN.md:492-500` is right); `backend/testing.md:67`
