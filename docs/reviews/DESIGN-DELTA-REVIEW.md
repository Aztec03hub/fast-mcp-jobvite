...
(`docs/DESIGN.md:1740`, `*(none)*`), so the second condition holds. The first does not: this round
...
**Where:** `docs/DESIGN.md:1672`, the C5-E1 row of §11.
...
**Where:** `docs/DESIGN.md:1640` (C3-I1), `:1683` (C6-D1), `:1775-1776` (the "Mitigate before
...
**Where:** `docs/DESIGN.md:1369-1375` (the disclaimer), `:1390` (the uncorrected sibling), plus
`:944`, `:1139`, `:1205`, `:1513`.
...
**Where:** `docs/DESIGN.md:813-817` (B107's ceiling), `:246-248` (B108's ceiling), `:1934-1937`
(§13's re-test step).
