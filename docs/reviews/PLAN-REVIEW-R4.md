...
committed-file-type gate (`DESIGN.md:1627-1637`)"*. `DESIGN.md:1627` is subject-correct - *"Two
...
`DESIGN.md:1624-1637`... I judged it a unit of its own rather than a corner of this one. Flagging
...
It is not cosmetic: **`DESIGN.md:1811` is C8-I1, a Critical row, and its mitigation text is
...
control (an ordinary `.py` commits) beside each refusal arm, and `DESIGN.md:1635-1637`'s stated
...
allow-list in the standards corpus, on day one, in the smallest unit.** D1 found `DESIGN.md:1811`
