...
> revision 4 - its `DESIGN.md:1070-1073` for the README deferral is now **`DESIGN.md:1483-1484`**.
...
| **B77** | README has all fourteen sections, exact headings | **SUPERSEDED (deferred, reason recorded)** | No root `README.md` (`git ls-files` shows `docs/README.md` only). Reason at `DESIGN.md:1483-1484` - *"**The README is not written yet, deliberately**"*. Scheduled as **U13** (`IMPLEMENTATION-PLAN.md:992-994`) | Yes - via §10.1 and U13, by subject not by number |
