...
**THE BLANKET POSITIVE CONTROL (`DESIGN.md:1451-1452`).** "A guard that
...
def test_case7_POSITIVE_CONTROL_a_well_formed_argument_passes(
    ...
    """§8 #7's positive control (`DESIGN.md:1451-1452`).
...
def test_case7_an_undeclared_argument_key_FAILS_CLOSED(
    ...
    """§8 #7 (`DESIGN.md:1370-1371`), B12 and B23.
...
# ======================================================================
# 4. §8 #8 - CONTROL CHARACTERS AND BIDI OVERRIDES (DESIGN.md:1372-1375)
# ======================================================================
...
def test_case8_POSITIVE_CONTROL_an_ordinary_name_passes(
    ...
    """§8 #8's own positive control, which `DESIGN.md:1373` names.
...
def test_the_no_success_envelope_rule_now_runs_over_the_COMPLETED_corpus() -> None:
    """§5.1 / `DESIGN.md:548`, re-asserted where it has teeth.
