"""The `FastMCP` instance and lifespan composition (DESIGN.md:936-938).

DESIGN.md:937-938 states "startup in order, teardown in strict reverse,
...
async def test_composed_lifespans_start_in_order_and_tear_down_in_reverse() -> None:
    """DESIGN.md:937-938, which had no test before this one.
...
async def test_the_server_registers_no_tool_yet() -> None:
    """U1 owns the enable GATE, not the tools (DESIGN.md:897-914).
